...
def if_this_not_that(i_list, this):
    ...
    "*** YOUR CODE HERE ***"
    def func(x):
        return "that" if x <= this else str(x)
    for i in map(func, i_list):
        print(i)
...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    return sqrt( pow(abs(get_lat(city1)-get_lat(city2)), 2) +
...
def closer_city(lat, lon, city1, city2):
    ...
    distance1 = distance(here, city1)
    distance2 = distance(here, city2)
