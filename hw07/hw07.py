...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        "*** YOUR CODE HERE ***"
        call_func = message[len(magic_word):]
        if hasattr(self.obj, call_func):
            return getattr(self.obj ,call_func)(*args)
        else:
            return 'Thanks for asking, but I know not how to {}.'.format(call_func)
